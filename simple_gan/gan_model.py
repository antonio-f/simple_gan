...
class GAN():
    ...
    def plot_model(self, run_folder):
        plot_model(self.model, 
                   to_file=os.path.join(run_folder ,'structure/model.png'), 
                   show_shapes = True, show_layer_names = True)
        plot_model(self.discriminator, 
                   to_file=os.path.join(run_folder , 'structure/discriminator.png'), 
                   show_shapes = True, show_layer_names = True)
        plot_model(self.generator, 
                   to_file=os.path.join(run_folder ,'structure/generator.png'), 
                   show_shapes = True, show_layer_names = True)
